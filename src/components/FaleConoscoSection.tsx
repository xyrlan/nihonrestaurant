...
const FaleConoscoSection = () => {
  ...
  return (
    <section className="flex min-h-screen items-center justify-center p-12 px-6 sm:p-24 max-sm:bg-center bg-cover bg-[url('/faleconoscohero.jpg')]">
        ...
        <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
          <div className="lg:col-span-2 lg:py-12 text-gray-100">
            ...
            <div className="mt-8 text-gray-100 hover:text-gray-400 duration-200 cursor-pointer">
              <Link href="#" className="text-xl font-semibold flex gap-2 items-center  "> (67) 99314-0747
