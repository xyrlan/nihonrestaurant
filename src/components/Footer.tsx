  ...
  return (
    <footer className="bg-[#292824] border-t border-black/50">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <Link href={'https://xyrlan.vercel.app/ptBR'} ><p className='text-xs text-gray-500 mt-4'>Desenvolvido por <span className='text-[#b93531] underline'>xyrlan</span></p> <br/><p className='text-xs text-gray-500 mt-4'>contato: <span className='text-[#b93531] underline'>61 9 99936169</span> </p> </Link>
      </div>
    </footer>
  )
}
