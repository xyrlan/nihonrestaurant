...
const CursoSection = () => {
  return (
    <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} id='cursos' className="flex min-h-screen items-center justify-center p-12 py-44 sm:py-64 px-6 sm:p-24  bg-[#292824]">
