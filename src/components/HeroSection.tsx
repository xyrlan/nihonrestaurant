...
const HeroSection = () => {
  return (
    <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 1 }} id='inicio' className="flex min-h-screen items-center justify-center sm:p-24 max-sm:bg-center bg-cover bg-[url('/nihon-hero.jpg')]">
